...
class AccountServiceMethodSecurityTest {
    ...
    public void getAuthoritiesForUser_should_return_authorities_for_superadmin() {
        ...
        String[] authorities = restTemplate
        ...
        assertThat(authorities.toString().contains("USER"));
        assertThat(authorities.toString().contains("ADMIN"));
        assertThat(authorities.toString().contains("SUPERADMIN"));
    }
}